<div>
    <x-zmd-modal title="Cadastrar novo usuário" wire persistent center>
        <form wire:submit='handle' id="create-user-form">
        ...
        <x-zmd-button form="create-user-form" type="submit" text="Salvar" color="orange" sm/>
        </x-slot:footer>
    </x-zmd-modal>
</div>
